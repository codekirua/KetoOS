...
export interface ChatsStoreState {
  ...
  rooms: ChatRoom[];
  currentRoomId: string | null; // ID of the currently selected room, null for AI chat (@keto)
      ...
      return {
        ...
        deleteRoom: async (roomId: string) => {
          ...
          try {
            ...
            // If we're currently in this room, switch to @keto
            const currentRoomId = get().currentRoomId;
