  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      if (currentRoomId && username) {
        ...
        // Detect if this is an @keto mention
        ...
        if (isMention) {
          ...
          // Send the user's message to the chat room first (showing @keto)
            ...
            <div className="relative flex flex-col flex-1 h-full bg-white/85">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  {/* Create Account button shown only in @keto view when no username is set */}
                  ...
                  {/* Clear chat button shown only in @keto (no current room) */}
                  {!currentRoom && (
                    <Button
                      variant="ghost"
              ...
              >
                ...
                >
                  {/* Show "Create Account" button in two cases:
                      ...
                      2. In @keto chat when rate limit is hit for anonymous users */}
